...
public final class QueryUtils {
     ...
     */
    public static List<Article> fetchHeadlineData(String requestUrl) {
        // Create URL object
...
private static List<Article> extractFeatureFromJson(String jsonResponse) {
        ...
        try{
            ...
            JSONArray articleArray=baseObject.getJSONArray("articles");

            for(int i=0;i<articleArray.length();i++){

                JSONObject currentObject=articleArray.getJSONObject(i);

                String headline=currentObject.getString("title");

                String imageUrl=currentObject.getString("urlToImage");

                String contentUrl=currentObject.getString("url");

                Article article=new Article(headline,imageUrl,contentUrl);
